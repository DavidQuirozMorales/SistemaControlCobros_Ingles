...
const ModalEditarEstudiante = ({ estudiante, closeModal, actualizarEstudiante }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(`http://localhost:3001/api/estudiantes/${estudiante.id}`, formData);
  ...
  return (
    <ModalContainer>
      <ModalContent>
        <FormTitle>Editar Estudiante</FormTitle>
